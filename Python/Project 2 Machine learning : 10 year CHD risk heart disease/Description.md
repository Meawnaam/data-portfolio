...
| **Ridge Classifier** | Linear Classifier | Reweighting, SMOTE, Undersampling | RobustScaler |
...
The **Logistic Regression (Class Reweighting)** model achieved the highest **Recall** of **0.886228**, meaning it correctly identified 88% of the actual CHD risk cases in the test set.
For a real-world medical screening tool where **False Negatives are life-critical**, the high recall of the Class Reweighting models is preferable, despite the higher number of false alarms (low precision).
